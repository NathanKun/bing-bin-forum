...
class CreateUsersTable extends Migration {
	...
	public function up()
	{
		Schema::create('Users', function(Blueprint $table)
		{
			...
			$table->integer('eco_point')->nullable()->default(0);
			...
			$table->integer('id_usagi')->nullable()->default(1);
			$table->integer('id_leaf')->nullable()->default(1);
			$table->integer('sun_point')->nullable()->default(0);
		});
	}
